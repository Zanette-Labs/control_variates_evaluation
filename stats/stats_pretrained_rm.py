...
if __name__ == "__main__":
    ...
    # Load data
    conv_a_reward, conv_b_reward, model_a_names, model_b_names, gt_scores = load_rm_rewards(args.rm_dict_file_path)
    # model_a_names, model_b_names, winners = load_gt_data("lmsys/chatbot_arena_conversations", split = "train")

    # sort_model = False
    print("Sort model", args.sort_model)
    # gt_scores, flips, new_model_a_names, new_model_b_names = get_gt_score(model_a_names, model_b_names, winners, sort_model = sort_model)

    # rm_scores = get_rm_score_binary(conv_a_reward, conv_b_reward, flips)
    # rm_scores = get_rm_score_bt(conv_a_reward, conv_b_reward, flips = None)
    rm_scores = utils.get_rm_score_bt(conv_a_reward, conv_b_reward)
    ...
    # corr_mat, num_mat, sorted_model_list = grouper.get_corr_mat()
