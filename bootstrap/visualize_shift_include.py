...
if __name__ == "__main__":
    ...
    # Visualize
    os.makedirs(os.path.join(result_file_dir, "images"), exist_ok=True)
    save_err_path = os.path.join(result_file_dir, "images", f"bootstrap_err_logscale.png")
    save_var_path = os.path.join(result_file_dir, "images", f"bootstrap_var.png")
